...
// @Param num1 path int true "第一个数字" default(36)
// @Param num2 path int true "第二个数字" default(4)
// @Success 200 {interface} response.ResponseResult
// @Response 200 {interface} response.ResponseResult
// @Router /add/{num1}/{num2} [get]
